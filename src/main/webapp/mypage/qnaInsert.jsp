...
<body>
	...
	<form action="QnaInsertPro.qna" method="post" name="qnaForm" enctype="multipart/form-data">
		...
		주문 상품 선택 <input type="text" name="oid" id="oid" readonly> <input type="button" value="주문 조회" onclick="window.open('QnaOrderList.qna','qnaOrderList','width=450,height=500')"><br>
