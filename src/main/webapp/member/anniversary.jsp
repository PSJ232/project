...
<body>
	<div class="anniversary_container">
		...
		<div class="page_title"><span>기념일 등록하기</span></div>	
			...
			<div class="inbox">
				...
				%>
					...
					<form action="MemberAnnUpdatePro.me" class="formAnniversary" method="post">
						...
						<div class="row">
						<div class="leftLabel">기념일<span class="textStar">*</span></label> 
						<input type="text" class="textBox" name="a_date" value="<%=annDetail.getA_date()%>"><!-- 클릭하면 달력뜨도록 가능?)--><br></div>
						<div class="row"><label class="leftLabel">기념일 이름<span class="textStar">*</span></label>
						<input type="text" class="textBox" name="a_name" value="<%=annDetail.getA_name()%>"><br></div>	
