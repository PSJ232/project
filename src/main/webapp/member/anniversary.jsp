...
<body>
	...
	<form action="MemberAnnUpdatePro.me" class="formAnniversary" method="post">
		<div class="row"><label class="leftLabel">기념일<span class="textStar">*</span></label> <input type="text" name="a_date" value="<%=annDetail.getA_date()%>"><!-- 클릭하면 달력뜨도록 가능?)--><br></div>
		<div class="row"><label class="leftLabel">기념일 이름<span class="textStar">*</span></label><input type="text" name="a_name" value="<%=annDetail.getA_name()%>"><br></div>	
		<div class="row"><label class="leftLabel">반복 주기<span class="textStar">*</span></label>
