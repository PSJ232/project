		...
		<div class="title"><h1>회원가입</h1></div>
			...
			<form action="MemberJoinPro.me" name=formJoin method="post">				
					...
					<div class="bottomForm">
							<div class="bottomContent"><input type="checkbox" name="m_agree" id="termCAll">모두 동의합니다.<br>
									<hr width=90% size="1px" color="#eaeaea">
									<input type="checkbox" name="m_agree" id="termC1" required>이용약관 동의 <span class="textRed">(필수)</span><br>
									<input type="checkbox" name="m_agree"  id="termC2" required>개인정보 수집, 이용동의 <span class="textRed">(필수)</span><br>
									<input type="checkbox" name="m_agree"  id="termC3" required>개인정보 이용 동의 <span class="textRed">(필수)</span><br>
