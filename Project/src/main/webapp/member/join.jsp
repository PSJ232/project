...
휴대폰 본인인증 <input type="tel" name="m_phone" placeholder="'-'없이 숫자만 입력해주세요."><input type="button" value="인증번호 받기"><br>
<input type="tel" placeholder="인증번호를 입력해주세요."><input type="button" value="확인"><br>
생년월일 <input type="text" name="year" placeholder="년도)1999"><input type="text" name="month" placeholder="월"><input type="text" name="day" placeholder="일"><br>
성별 <input type="radio" name="m_gender" value="1">여성
