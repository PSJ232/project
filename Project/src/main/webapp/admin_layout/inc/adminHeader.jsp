        ...
        <div>
          ...
          <nav class="main_menu">
            ...
            <div class="nav_bar_icon">
              <a href="#"><img src="admin_layout/img/profile.png" alt="go to mypage" class="nav_icon"></a>
              <a href="#"><img src="admin_layout/img/bag.png" alt="shopping cart" class="nav_icon"></a>
            </div>
          </nav>
        </div>
      </header>
